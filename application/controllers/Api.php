...
class Api extends CI_Controller {
 ...
 function insert()
 {
  ...
  $this->form_validation->set_rules("positif", "Last Name", "required");
  $array = array();
  if($this->form_validation->run())
  {
   $data = array(
    'name' => trim($this->input->post('name')),
    'positif'  => trim($this->input->post('positif'))
   );
  ...
  else
  {
   $array = array(
    ...
    'positif_error' => form_error('positif')
   );
  }
